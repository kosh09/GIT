...
void loop()
{
  if(Serial.available())
  {
    ...
    if(Data >= 10 && Data <= 79)
    {
      Serial_algorithm(Data);    // Servo , Fast & Direction
    }
    if(Data >= 59 && Data <= 79)
    {
     light.update(); 
...
void Serial_algorithm(int A)
{
  ...
  else if(A == 13){myservo.write(145); digitalWrite(Motor_dir, !(Current_Dir));analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HR50
  ...
  else if(A == 20){myservo.write(130); digitalWrite(Motor_dir, !(Current_Dir));analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HR35
  ...
  else if(A == 27){myservo.write(110); digitalWrite(Motor_dir, !(Current_Dir));analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HR15
  ...
  else if(A == 34){myservo.write(95); digitalWrite(Motor_dir, !(Current_Dir)); analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH); light.on();} //   HS00
  ...
  else if(A == 41){myservo.write(80); digitalWrite(Motor_dir, !(Current_Dir)); analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HL15
  ...
  else if(A == 48){myservo.write(60); digitalWrite(Motor_dir, !(Current_Dir)); analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HL35
  ...
  else if(A == 55){myservo.write(45); digitalWrite(Motor_dir, !(Current_Dir)); analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HL50
  ...
  else if(A == 60){myservo.write(145); digitalWrite(Motor_dir, !(Current_Dir));  analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HR50
  ...
  else if(A == 63){myservo.write(130); digitalWrite(Motor_dir, !(Current_Dir));  analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HR35
  ...
  else if(A == 66){myservo.write(110); digitalWrite(Motor_dir, !(Current_Dir));  analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HR15
  ...
  else if(A == 69){myservo.write(95); digitalWrite(Motor_dir, !(Current_Dir));   analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HS00
  ...
  else if(A == 72){myservo.write(80); digitalWrite(Motor_dir, !(Current_Dir));   analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HL15
  ...
  else if(A == 75){myservo.write(60); digitalWrite(Motor_dir, !(Current_Dir));   analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HL35
  ...
  else if(A == 78){myservo.write(45); digitalWrite(Motor_dir, !(Current_Dir));   analogWrite(Motor_pwm,   0); digitalWrite(Motor_brk, HIGH);} //   HL50
  else if(A == 79){myservo.write(45); digitalWrite(Motor_dir, LOW);    analogWrite(Motor_pwm, 120); digitalWrite(Motor_brk, LOW);}  //   BL50
  
  Current_Dir=digitalRead(Motor_dir);
}
